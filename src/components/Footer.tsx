...
const Footer = () => {
  return (
    <footer className="border-t border-border py-10 bg-muted/5">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <h4 className="font-bold mb-3 uppercase tracking-wider">Ссылки</h4>
            ...
            <div>
              <h4 className="font-bold mb-3 uppercase tracking-wider">Разделы</h4>
              <ul className="space-y-2 text-muted-foreground">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center text-sm text-muted-foreground">
            ...
            <svg className="w-4 h-4 ml-2 mr-1" viewBox="0 0 256 417" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
              <path fill="#e11d48" d="M127.961 0l-2.795 9.5v275.668l2.795 2.79 127.962-75.638z" />
              <path fill="#e11d48" d="M127.962 0L0 212.32l127.962 75.639V154.158z" />
              <path fill="#e11d48" d="M127.961 312.187l-1.575 1.92v98.199l1.575 4.601L256 236.587z" />
              <path fill="#e11d48" d="M127.962 416.905v-104.72L0 236.585z" opacity=".5" />
              <path fill="#e11d48" d="M127.961 287.958l127.96-75.637-127.96-58.162z" opacity=".2" />
              <path fill="#e11d48" d="M0 212.32l127.96 75.638v-133.8z" opacity=".6" />
            </svg>
            <span>Ethereum</span>
          </div>
        </div>
